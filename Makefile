...
.PHONY: $(TARGETS) $(TARGETS_CONFIG) all br clean help

all: $(TARGETS)

br:
	$(MAKE) -C $(BUILDROOT) O=$(O) BR2_EXTERNAL=$(BUILDROOT_EXTERNAL) $(filter-out $@,$(MAKECMDGOALS))
...
help:
	...
	@echo "Run 'make br <command> to run any buildroot commands."
